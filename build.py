...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','jp.king3.webview.plus.js')
	...
	f = os.path.join(cwd,'Classes','JpKing3WebviewPlusModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','jp.king3.webview.plus.js']
